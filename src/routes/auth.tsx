...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: `Sign in or create your free ${BRAND.name} account to post ads, save listings, and message neighbors.` },
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin" ? "Sign in to post and manage your ads." : "Free to join. Post your first ad in under a minute."}
          </p>

          <Button onClick={handleGoogle} disabled={loading} variant="outline" className="mt-6 w-full h-11">
